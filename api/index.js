...
<body oncontextmenu="return false;">
    <div class="header">
        <div class="header-content">
            ...
            <div class="status-badge">⚡ Ultra Fast Streaming</div>
        </div>
    </div>
        ...
        <div id="videoSection" class="video-section">
            ...
            <div class="player-wrapper" id="playerWrapper">
                ...
                <div class="settings-menu" id="settingsMenu">
                    ...
                    <div class="menu-section" id="qualitySection" style="display: none;">
                        <div class="menu-title">Quality</div>
                        <div class="menu-item active" onclick="setQuality('auto')" data-quality="auto">
                            <span>Auto</span>
                            <span class="check">✓</span>
                        </div>
                    </div>
