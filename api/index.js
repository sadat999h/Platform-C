    ...
    <script>
        ...
        async function loadVideo() {
            ...
            try {
                ...
                console.log('Security key:', SEC);
                console.log('Encoded key:', encodeURIComponent(SEC));
                ...
                if (data.type === 'embed') {
                    ...
                    console.log('Video source set to:', vid.src);
        ...
        function initControls() {
            ...
            vid.onerror = (e) => {
                ...
                console.error('Error code:', vid.error ? vid.error.code : 'unknown');
                console.error('Error message:', vid.error ? vid.error.message : 'unknown');
                console.error('Current src:', vid.src);
