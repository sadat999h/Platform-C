...
<body oncontextmenu="return false;">
    ...
    <script>
        ...
        function initControls() {
            ...
            vid.onwaiting = () => buffer.classList.add('show');
            vid.oncanplay = () => buffer.classList.remove('show');
            vid.oncanplaythrough = () => buffer.classList.remove('show');
            
            // Better buffering detection
            vid.onstalled = () => buffer.classList.add('show');
            vid.onsuspend = () => buffer.classList.remove('show');
            vid.onplaying = () => buffer.classList.remove('show');
            vid.onloadeddata = () => buffer.classList.remove('show');
